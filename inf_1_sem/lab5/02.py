...
FPS = 30 
screen = pg.display.set_mode((927+500-100, 769)) 
f1 = pg.Surface((927, 769))
f2 = pg.Surface((927, 769))
myfont = pg.font.SysFont('arial', 60)
textsurface = myfont.render('Python realllllly sucks!!!', False, (0, 0, 0))
...
f2 = man(f2, sc,se,gr,ye)

f1.set_colorkey(wh)
f2.set_colorkey(wh)

f1 = pg.transform.scale(f1,(int(927/2)+250,768))
f2 = pg.transform.scale(f2,(int(927/2)+250,768))

screen.blit(f1,(0,0))
screen.blit(f2,(int(927/2-100+250),0))

pg.draw.rect(screen,lg,(0,0,927+500-100,90),0)
pg.draw.rect(screen,bl,(0,0,927+500-100,90),1)
